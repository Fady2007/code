      ...
      r = {
          ...
          class a {
            ...
            invoke(e, t = {}) {
              ...
              return (
                ...
                (h = function* () {
                  try {
                    const { headers: s, method: a, body: l } = t;
                    let h,
                      c = {};
                    l &&
                      ((s &&
        ...
        165: (e, t, r) => {
              ...
              (function (e) {
                ...
                for (e = e.replace("-", "+").replace("_", "/"); c < e.length; )
                  (n = t.indexOf(e.charAt(c++))),
                    ...
                    64 != l && 0 != i && (h += String.fromCharCode(i));
                return h;
              })(r)
            );
          }
                            ...
                            x(void 0, void 0, void 0, function* () {
                              ...
                              "function" == typeof r.json
                                ? [502, 503, 504].includes(e.status)
                                  ? t(new P(A(e), e.status))
                                  : e
                                      .json()
                                      .then((r) => {
                                        t(new b(A(r), e.status || 500));
                                      })
                                      .catch((e) => {
                                        t(new w(A(e), e));
                                      })
          ...
          class L {
            ...
            signOut(e) {
              return N(this, void 0, void 0, function* () {
                try {
                  return (
                    yield $(this.fetch, "POST", `${this.url}/logout`, {
            ...
            inviteUserByEmail(e, t = {}) {
              return N(this, void 0, void 0, function* () {
                try {
                  return yield $(this.fetch, "POST", `${this.url}/invite`, {
                    body: {
                      email: e,
                      data: t.data,
                    },
              ...
              return N(this, void 0, void 0, function* () {
                try {
                  const l = {
                    ...
                    h = yield $(this.fetch, "GET", `${this.url}/admin/users`, {
                      headers: this.headers,
                      noResolveJson: !0,
                      query: {
                        page:
          ...
          const M = {
              ...
              headers: {
                "X-Client-Info": "gotrue-js/2.31.0",
              },
              flowType: "implicit",
            },
            J = 3e4;
          class H {
            ...
            _initialize() {
              return B(this, void 0, void 0, function* () {
                ...
                try {
                  const e = !!i() && (yield this._isPKCEFlow());
                  if (
                    e ||
              ...
              return B(this, void 0, void 0, function* () {
                try {
                  ...
                  if ((yield this._removeSession(), "email" in e)) {
                    ...
                    i = yield $(this.fetch, "POST", `${this.url}/signup`, {
                      headers: this.headers,
            ...
            signInWithSSO(e) {
              ...
              return B(this, void 0, void 0, function* () {
                try {
                  return (
                    yield this._removeSession(),
                    yield $(this.fetch, "POST", `${this.url}/sso`, {
                      body: Object.assign(
                        Object.assign(
                          Object.assign(
                            Object.assign(
                ...
                try {
                  ...
                  if ("email" in e) {
                    const { email: r, type: s, options: i } = e,
                      { error: n } = yield $(this.fetch, "POST", t, {
                        headers: this.headers,
                        body: {
                          email: r,
                          type: s,
                  ...
                  if ("phone" in e) {
                    const { phone: r, type: s, options: i } = e,
                      { data: n, error: o } = yield $(this.fetch, "POST", t, {
                        headers: this.headers,
                        body: {
                          phone: r,
                          type: s,
            ...
            getUser(e) {
              ...
              return B(this, void 0, void 0, function* () {
                try {
                  ...
                  return yield $(this.fetch, "GET", `${this.url}/user`, {
                    headers: this.headers,
                    jwt: e,
                    xform: R,
                  });
            ...
            updateUser(e, t = {}) {
              return B(this, void 0, void 0, function* () {
                try {
                  ...
                  if (s) throw s;
                  if (!r.session) throw new E();
                  const i = r.session,
                    { data: n, error: o } = yield $(
                      this.fetch,
                      "PUT",
                      `${this.url}/user`,
                      {
                  ...
                  return (
                    ...
                    yield this._notifyAllSubscribers("USER_UPDATED", i),
                    {
                      data: {
                        user: i.user,
                      },
            ...
            _getSessionFromUrl(e) {
              return B(this, void 0, void 0, function* () {
                try {
                  if (!i()) throw new j("No browser detected.");
                  if (
                  ...
                  if ("pkce" == this.flowType && !e)
                    throw new k("Not a valid PKCE flow url.");
                  if (e) {
                    const e = a("code");
                    if (!e) throw new k("No code detected.");
                    const { data: t, error: r } =
                      yield this.exchangeCodeForSession(e);
                    if (r) throw r;
                    if (!t.session) throw new k("No session detected.");
                  ...
                  if (t) {
                    ...
                    if (!e) throw new j("No error_code detected.");
                    const r = a("error");
                    if (!r) throw new j("No error detected.");
                    throw new j(t, {
                      error: r,
                      code: e,
                    });
                  ...
                  const r = a("provider_token"),
                    ...
                    n = a("access_token");
                  if (!n) throw new j("No access_token detected.");
                  const o = a("expires_in");
                  if (!o) throw new j("No expires_in detected.");
                  const l = a("refresh_token");
                  if (!l) throw new j("No refresh_token detected.");
                  const h = a("token_type");
                  if (!h) throw new j("No token_type detected.");
            ...
            _isPKCEFlow() {
              return B(this, void 0, void 0, function* () {
                ...
                return Boolean(a("code")) && Boolean(e);
              });
            }
            signOut() {
              var e;
            ...
            emitInitialSession(e) {
              ...
              return B(this, void 0, void 0, function* () {
                try {
                  ...
                  if (s) throw s;
                  yield null === (t = this.stateChangeEmitters.get(e)) ||
                  void 0 === t
                    ? void 0
                    : t.callback("INITIAL_SESSION", r);
                } catch (t) {
                  yield null === (r = this.stateChangeEmitters.get(e)) ||
                  void 0 === r
                    ? void 0
            ...
            resetPasswordForEmail(e, t = {}) {
              return B(this, void 0, void 0, function* () {
                ...
                if ("pkce" === this.flowType) {
                  const e = v();
                  yield h(this.storage, `${this.storageKey}-code-verifier`, e),
                    (r = yield y(e)),
                    (s = e === r ? "plain" : "s256");
                }
                try {
                  return yield $(this.fetch, "POST", `${this.url}/recover`, {
                    body: {
                      email: e,
                      code_challenge: r,
            ...
            _callRefreshToken(e) {
              ...
              return B(this, void 0, void 0, function* () {
                ...
                try {
                  if (((this.refreshingDeferred = new d()), !e)) throw new E();
                  const { data: t, error: r } = yield this._refreshAccessToken(
                    e
                  );
                  if (r) throw r;
                  if (!t.session) throw new E();
            ...
            _notifyAllSubscribers(e, t, r = !0) {
              return B(this, void 0, void 0, function* () {
                ...
                const s = [],
                  i = Array.from(this.stateChangeEmitters.values()).map((r) =>
                    B(this, void 0, void 0, function* () {
                      try {
                        yield r.callback(e, t);
                      } catch (e) {
                        s.push(e);
                      }
                    })
                  );
                if ((yield Promise.all(i), s.length > 0)) {
            ...
            _persistSession(e) {
              return h(this.storage, this.storageKey, e);
            }
            _removeSession() {
              return B(this, void 0, void 0, function* () {
                this.persistSession
            ...
            _autoRefreshTokenTick() {
              return B(this, void 0, void 0, function* () {
                ...
                try {
                  ...
                  Math.floor((1e3 * t.expires_at - e) / J) < 3 &&
        ...
        189: (e, t, r) => {
          ...
          const h = {
            "X-Client-Info": "postgrest-js/1.7.0",
          };
          class c {
            constructor(e, { headers: t = {}, schema: r, fetch: s } = {}) {
              (this.url = e),
        ...
        73: (e, t, r) => {
          ...
          var s = r(840);
          const i = {
            "X-Client-Info": "realtime-js/2.7.3",
          };
          var n, o, a, l, h, c, u;
          !(function (e) {
          ...
          class x {
            ...
            _trigger(e, t, r) {
              ...
              const n = e.toLocaleLowerCase(),
                { close: o, error: l, leave: h, join: c } = a;
              if (r && [o, l, h, c].indexOf(n) >= 0 && r !== this._joinRef())
                return;
                    ...
                    (this._bodyInit = e),
                      e
                        ? "string" == typeof e
                          ...
                          ? (this._bodyBlob = e)
                          : n && FormData.prototype.isPrototypeOf(e)
          ...
          t.default = class {
            ...
            _initSupabaseAuthClient(
              ...
              return new u.SupabaseAuthClient({
                url: this.authUrl,
                headers: Object.assign(Object.assign({}, l), o),
                storageKey: i,
                autoRefreshToken: e,
                persistSession: t,
                detectSessionInUrl: r,
            ...
            (t.fetchWithAuth = (e, r, s) => {
              ...
              return (t, s) =>
                o(void 0, void 0, void 0, function* () {
                  ...
                  let l = new n(null == s ? void 0 : s.headers);
                  return (
